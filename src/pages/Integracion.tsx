      ...
      {(config.tenant.plan === 'pro' || config.tenant.plan === 'full') ? (
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
          ...
          <TabsContent value="marketplace">
             {/* We render the professional IntegracionesPage here, which includes:
                 - Integrations List (ML, TN, WhatsApp)
                 - Chat Customizer (Live Preview)
          ...
          {/* --- WHATSAPP TAB (Legacy/Inventory Management) --- */}
