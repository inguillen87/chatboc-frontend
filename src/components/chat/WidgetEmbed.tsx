...
const WidgetEmbed = ({ token }: { token: string }) => {
  ...
  const embedCode = `<script async src="https://cdn.chatboc.ar/widget/v1.js" data-api-base="https://chatboc.ar" data-owner-token="${token}" data-endpoint="${tipoChat}" data-default-open="false" data-width="460px" data-height="680px" data-closed-width="112px" data-closed-height="112px" data-bottom="20px" data-right="20px"></script>`;
