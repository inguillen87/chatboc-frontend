...
const WidgetEmbed = ({ token }: { token: string }) => {
  ...
  const embedCode = `<script>(function(){var s=document.createElement('script');s.src='https://chatboc.ar/widget.js';s.async=true;s.setAttribute('data-owner-token','${token}');s.setAttribute('data-endpoint','${tipoChat}');document.head.appendChild(s);})();</script>`;
