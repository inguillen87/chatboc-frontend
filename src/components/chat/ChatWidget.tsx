...
const ChatWidget: React.FC<ChatWidgetProps> = ({
  ...
  // isMobile solo es relevante para el modo standalone si quieres tamaños fluidos
  ...
  const commonPanelStyles = cn(
    "bg-card border shadow-2xl rounded-lg", // Estilos de la tarjeta
    ...
    (open: boolean) => {
      if (
        ...
        window.parent.postMessage(
          ...
          "*" // Seguridad en producción: usa el origen específico del padre
        );
      }
    },
  ...
  // Persistir entityToken si viene por prop y estamos en modo iframe
  useEffect(() => {
    ...
    >
      <Suspense fallback={null}>
        ...
        <motion.div
          ...
          style={{
            // Estas dimensiones aseguran que el panel del ChatWidget intente llenar el iframe
