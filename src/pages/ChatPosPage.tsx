    ...
    <main className="bg-background text-foreground py-20 px-6 md:px-12">
      ...
      <section className="text-center max-w-5xl mx-auto mb-24">
        ...
        <motion.h1
          ...
          className="text-5xl font-bold mb-4 text-primary dark:text-green-400"
        >
          ChatPos
        </motion.h1>
      ...
      <section className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center mb-24">
        <div>
          <h2 className="text-3xl font-semibold mb-6 text-foreground">Solución completa para tu negocio</h2>
      ...
      <section className="max-w-5xl mx-auto text-center">
        <h2 className="text-3xl font-semibold mb-10 text-foreground">Planes accesibles para cada etapa</h2>
        <div className="grid md:grid-cols-3 gap-8">
          <motion.div
            whileHover={{ scale: 1.03 }}
            className="border p-6 rounded-2xl shadow-sm bg-card border-border text-foreground"
          >
            <h3 className="text-xl font-bold mb-2 text-foreground">Básico</h3>
            <p className="text-muted-foreground mb-3">Para un solo local</p>
            <p className="text-3xl font-bold text-primary dark:text-green-400">$/mes</p>
          </motion.div>
          <motion.div
