...
const Integracion = () => {
  ...
  // Eliminamos previewContainerRef si no es necesario para la vista previa estática.
  ...
  // ELIMINAMOS TODA LA LÓGICA DE USEEFFECT PARA LA VISTA PREVIA DINÁMICA DE AQUÍ.
  // useEffect(() => { ... }, [user]);
