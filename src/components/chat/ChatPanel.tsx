...
import ChatHeader from "./ChatHeader"; // Asegúrate de que esta ruta sea correcta y que ChatHeader existe
...
interface ChatPanelProps {
  ...
  widgetId?: string;
  entityToken?: string;
  initialIframeWidth?: string; // Aunque no se usa directamente para el layout aquí, se mantiene por compatibilidad
  initialIframeHeight?: string; // Aunque no se usa directamente para el layout aquí, se mantiene por compatibilidad
  onClose?: () => void;
  openWidth?: string; // Es string porque viene de props de ChatWidget
  openHeight?: string; // Es string porque viene de props de ChatWidget
...
const ChatPanel = ({
  ...
  initialIframeHeight,
  onClose,
  openWidth, // Usado directamente, no estados locales
  openHeight, // Usado directamente, no estados locales
