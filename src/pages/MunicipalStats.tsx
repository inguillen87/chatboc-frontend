...
export default function MunicipalStats() {
  ...
  return (
    <div className="p-4 max-w-4xl mx-auto space-y-6">
      ...
      <Card className="shadow-lg">
        <CardHeader>
          <CardTitle className="text-xl">Resumen de Estadísticas</CardTitle>
        </CardHeader>
        <CardContent>
          <ul className="grid gap-3 text-base">
            {data.stats.map((item) => (
              <li key={item.label} className="flex justify-between border-b border-border pb-2 last:border-b-0 last:pb-0">
