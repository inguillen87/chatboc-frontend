...
const ChatWidget: React.FC<ChatWidgetProps> = ({
  ...
  // --- Cargar rubros (sólo si hace falta)
  ...
  // --- Drag&Drop (solo modo standalone)
  ...
  // --- Toggle y comunicación con widget.js (iframe)
  const toggleChat = () => {
        ...
        {!isOpen && (
          ...
          >
            <div className="relative">
              ...
              <span className="absolute -top-1 -right-1 w-3 h-
