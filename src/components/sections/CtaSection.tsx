        ...
        <div className="text-center max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 flex-wrap">
            <Button
              size="lg"
              variant="secondary"
              className="text-blue-800 bg-white hover:bg-white/90 font-semibold focus-visible:ring-2"
            ...
            <Button
              size="lg"
              className="bg-white text-blue-800 hover:bg-white/90 font-semibold focus-visible:ring-2"
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-white text-white hover:bg-white/10 focus-visible:ring-2"
              onClick={() =>
                window.open(
